  ...
  return <div className="md:hidden">
    ...
    {open && <div className="fixed inset-0 z-[100]">
      ...
      <aside className="relative ml-auto flex h-full w-[min(20rem,86vw)] flex-col bg-paper p-6 text-ink shadow-2xl">
        <div className="flex items-center justify-between"><span className="font-display text-lg tracking-[.16em]">STUDIO TWO</span><button type="button" aria-label="Close navigation" onClick={() => setOpen(false)} className="grid size-10 place-items-center border border-black/15"><X size={20}/></button></div>
