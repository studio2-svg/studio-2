...
export function AdminLoginForm() {
  ...
  return (
    <form action={action} className="mt-10 space-y-5">
      ...
      <button
        disabled={pending}
        className="w-full bg-gold px-5 py-4 text-sm uppercase tracking-[.2em] text-ink disabled:opacity-50"
      >
  ...
  return (
    <label className="block text-sm text-white/75">
      ...
      <input
        ...
        className="w-full border border-white/20 bg-white/5 px-4 py-3 text-white outline-none focus:border-gold"
      />
    </label>
  );
}
