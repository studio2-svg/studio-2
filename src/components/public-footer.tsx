...
export async function PublicFooter() {
  ...
  return <footer className="border-t border-current/15 bg-ink text-paper">
    <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-[1.5fr_1fr_1fr]">
      <div><Link href="/" aria-label="Studio 2 home"><SiteLogo tone="white" large /></Link><p className="mt-5 max-w-sm text-sm leading-6 text-white/50">{data?.description || "Studio details can be published from the administration portal."}</p></div>
